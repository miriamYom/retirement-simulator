...
[ApiController]
[Route("[controller]")]
public class RetirementSimulatorController : ControllerBase
{
    ...
    public RetirementSimulatorController(IUserServiceBL us, IPensionFactory pf, IJWTManagerRepository jWTManager, ITokenServiceBL ts)
    {
        userServiceBL = us;
        pensionFactory = pf;
