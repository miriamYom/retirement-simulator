...
public class PensionService
{
    ...
    /// </summary>
    /// <returns></returns>
    public static double EmployeesAgeAtRetirement()
    {
        return TotalYears(CurrentEmployee.BirthDate, CurrentEmployee.RetirementDate);
    }
    /// <summary>
    ...
    //            }
    //        }
    //        else if (EmployeesAgeAtRetirement() >= 50)
    //        {
